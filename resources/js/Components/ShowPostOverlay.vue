...
<template>
    <div id="OverlaySection" class="fixed z-50 top-0 left-0 w-full h-screen bg-[#000000] bg-opacity-60 p-3">
        ...
        <div class="max-w-6xl h-[clac(100%-100px)] mx-auto mt-10 bg-white rounded-xl">
            <div class="w-full md:flex h-full overflow-auto rounded-xl">
                <div class="flex items-center bg-black w-full">
                    <img src="https://picsum.photos/id/54/600/620" alt="" class="rounded-xl min-w-[400px] p-4 mx-auto">
                </div>
                <div class="md:max-w-[500px] w-full relative">
                    <div class="flex items-center justify-between p-3 border-b">
                        <div class="flex items-center">
                            <img src="https://picsum.photos/id/54/400/420" class="rounded-full w-[38px] h-[38px]" alt="">
                    ...
                    <div class="overflow-y-auto h-[clac(100%-170px)]">
                        <div class="flex items-center justify-between p-3">
                            <div class="flex items-center relative">
                                <img class="absolute -top-1 rounded-full w-[38px] h-[38px]"
                                    src="https://picsum.photos/id/54/400/420" alt="">
                        ...
                        <div class="p-3">
                            <div class="flex item-center justify-between">
                                <div class="flex items-center">
                                    <img src="https://picsum.photos/id/54/800/820" alt=""
