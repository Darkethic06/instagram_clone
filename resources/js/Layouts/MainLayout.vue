    ...
    <div id="MainLayout" class="w-full h-screen">
        <div v-if="$page.url === '/'" id="TopNavHome"
            ...
            <div class="flex items-center justify-between h-full">
                <Link href="/">
                <img src="/insta-logo.png" alt="" class="w-[150px] ml-6 cursor-pointer">
                </Link>
        ...
        <div id="SideNav"
            ...
            <div class="px-3">
                ...
                <MenuItem iconString="Create" @click="$event => showCreatePost = true" class="mb-4" />
        ...
        <div class="flex lg:justify-between bg-white h-full w-[100%-280px] lg:pl-[100px] overflow-auto">
            ...
            <div v-if="$page.url === '/'" id="SuggestionsSection" class="lg:w-3/12 lg:block hidden text-black mt-10">
                ...
                <Link href="/" class="flex items-center justify-between max-w-[300px] ">
                <div class="flex items-center">
                    <img src="https://picsum.photos/id/50/300/320" class="rounded-full z-10 w-[37px] h-[37px]" alt="" />
                    <div class="pl-4">
                        <div class="text-black font-extrabold">Name Here 1</div>
                        <div class="text-gray-500 text-extrabold text-sm">Name Here 2</div>
                    </div>
                ...
                <div class="max-w-[300px] mt-5">
                    <div class="text-sm text-gray-400">
                        About Help Press API Privacy Jobs Terms Locations Language Meta Verified
                    </div>
        ...
        <div id="BottomNav"
            ...
            <AccountOutline Color="#000000" :size="33" class="cursor-pointer" />
            <Link href="/">
